...
def validate_answer():
    ...
    i = 0 # this is my base count.  
    while True:
        user_input = raw_input ("Enter Answer here: ") # For the user to enter the input.
        while user_input != validate_list[i]: # Negative conditioning for cases in which the answer is not correct.
         if i < 3: # Sets top limit of count.
        ...
        while user_input == validate_list[i]: # Conditioning for when the answer is correct.
         if i < 3: # IF still within the allowed count.
             print "\nCongratulations! Your answer is correct.\n\n" + print_filled_quiz[i] +"\n\nPlease continue. " #Communicated the user that the answer was right and placed it in the quiz, filling the blanck.
             i = i+1 # To stops the loop.
         else:     
